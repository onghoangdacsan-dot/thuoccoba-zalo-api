...
<style>
:root{
  --bg:#f4f6f9; --panel:#ffffff; --card:#ffffff; --line:#e2e8f0;
  --gold:#d97706; --gold2:#f59e0b; --brown:#78350f; --text:#1e293b; --muted:#64748b;
...
.sidebar{background:#ffffff;border-right:1px solid var(--line);padding:20px 14px;position:sticky;top:0;height:100vh;box-shadow:2px 0 10px rgba(0,0,0,0.02)}
...
.brand h1{font-size:14px;margin:0;line-height:1.25;color:var(--text)}.brand span{font-size:11px;color:var(--muted)}
...
.nav button.on,.nav button:hover{background:#fef3c7;color:var(--brown)}
...
.topbar h2{margin:0;font-size:22px;font-weight:800;letter-spacing:-.02em;color:var(--text)}
.topbar .sub{color:var(--muted);font-size:12px;margin-top:4px}
.actions{display:flex;gap:8px;flex-wrap:wrap}
.btn-gold{background:linear-gradient(135deg,var(--gold2),var(--gold));color:#fff;box-shadow:0 2px 6px rgba(217,119,6,0.3)}
...
.hero p{margin:0;color:#fef3c7;font-size:13px;max-width:520px;line-height:1.5}
...
.panel-title{font-size:14px;font-weight:700;margin:0 0 12px;display:flex;align-items:center;gap:8px;color:var(--text)}
.filters{display:flex;flex-wrap:wrap;gap:8px;align-items:center;margin-bottom:10px}
.chip{background:#f1f5f9;border:1px solid var(--line);color:var(--muted);border-radius:999px;padding:8px 14px;font-size:12px;font-weight:600}
.chip.on{background:var(--brown);border-color:var(--brown);color:#fff}
input,select{background:#ffffff;border:1px solid var(--line);color:var(--text);border-radius:10px;padding:9px 12px}
...
.products{font-size:11px;color:#334155;margin-top:4px;line-height:1.4;font-weight:500}
...
#loginBox h1{margin:0 0 4px;font-size:22px;color:var(--text)}#loginBox p{color:var(--muted);font-size:13px}
...
.banner-card{border-radius:14px;overflow:hidden;border:1px solid var(--line);background:#fafaf9;min-height:120px;position:relative}
.banner-card .bg{position:absolute;inset:0;opacity:.2;background-size:cover;background-position:center}
.banner-card .body{position:relative;padding:14px}
.banner-card h4{margin:0 0 4px;font-size:14px;color:var(--text)}.banner-card p{margin:0;font-size:12px;color:var(--muted)}
